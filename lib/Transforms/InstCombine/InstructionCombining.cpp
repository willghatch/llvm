...
PreservedAnalyses InstCombinePass::run(Function &F,
  ...
  if (!combineInstructionsOverFunction(F, Worklist, nullptr, AC, TLI, DT, LVI,
...
bool InstructionCombiningPass::runOnFunction(Function &F) {
  ...
  return combineInstructionsOverFunction(F, Worklist, AA, AC, TLI, DT, LVI,
                                         ExpensiveCombines, LI);
}
